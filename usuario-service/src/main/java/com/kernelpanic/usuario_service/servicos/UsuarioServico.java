...
public class UsuarioServico {
    ...
    public void cadastrar(Usuario usuario) {
        ...
        try {
            ...
            authPayload.put("cpf", usuario.getCpf());
            ...
            restTemplate.postForObject(
                    "http://auth-service-app:8081/auth/cadastro",
                    authPayload,
                    Void.class);
    ...
    public void atualizar(Usuario atualizacao) {
        ...
        if (atualizacao.getCpf() != null) {
            usuario.setCpf(atualizacao.getCpf());
        }
        ...
        if (atualizacao.getGerente() != null
                && atualizacao.getGerente().getId() != null) {
        ...
        if (atualizacao.getSenha() != null
                && !atualizacao.getSenha().isBlank()) {

            usuario.setSenha(
                    passwordEncoder.encode(atualizacao.getSenha()));
        }
    ...
    public void atualizarViaDTO(Long id, UsuarioAtualizarDTO dto) {
        ...
        repositorio.findByCpf(dto.getCpf())
        ...
        repositorio.findByEmail(dto.getEmail())
                .ifPresent(usuarioExistente -> {
                    if (!usuarioExistente.getId().equals(id)) {
                        throw new RuntimeException("E-mail já cadastrado");
                    }
